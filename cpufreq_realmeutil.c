 ...
 * 
 * Update time: 2020-10-08 23:45:13 CST
 * Author: Unknown
 *
 */
...
#ifdef CONFIG_STICKERNEL_DEBUG
/* Debug frequency */
	unsigned int debug_cpufreq_a;
	unsigned int debug_cpufreq_b;
	unsigned int debug_cpufreq_load_a;
	unsigned int debug_cpufreq_load_b;
#endif
};
struct sugov_policy {
